...
We did not use the method, due to the fact that we already had used the Planning Poker method. \textbf{ [TODO: So we didn't consider every option before choosing? Poor choice of words. It took us long time to estimate using Planning Poker, and PERT would have chosen more than twice as long! ]}
