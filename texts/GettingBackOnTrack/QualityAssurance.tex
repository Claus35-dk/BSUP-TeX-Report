...
The usage of a test strategy, increases the likelihood of finding errors early and correcting them, thereby minimizing the amount of time spend on debugging. When one defines the test criteria, combined with the product requirements, we get one way of measuring quality \cite[p. ?]{PM}. [TODO: Clarify previous line ]
...
During the project's development fase, we had code reviews, first after the server was done. Mainly in order to have everybody understand what the different parts of the server did. It had the effect of illuminating code duplication and 
